$(function () {
  $(document).on('click', '#follow', function (e) {
    ...
    $.ajax({
      ...
      success: function (data) {
        $('#follow').removeClass('btn-default').addClass('btn-primary').html('Following').attr('id', 'unfollow')
      },
      error: function (data) {
        console.log(data)
      }
  ...
  $(document).on('click', '#unfollow', function (e) {
    ...
    $.ajax({
      ...
      success: function (data) {
        $('#unfollow').removeClass('btn-primary').addClass('btn-default').html('Follow').attr('id', 'follow')
      },
      error: function (data) {
        console.log(data)
      }
  ...
  $(document).on('mouseleave', '#follow', function (e) {
    $(this).removeClass('btn-danger').addClass('btn-default').html('Follow')
  })
